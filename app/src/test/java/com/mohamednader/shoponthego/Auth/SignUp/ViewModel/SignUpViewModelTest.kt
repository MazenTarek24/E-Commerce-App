...
var priceRules= mutableListOf<PriceRules>()
    ...
    @Test
    fun `createCustomer with invalid input`() = runBlockingTest {
        // given
        val customer = SingleCustomerResponse(com.mohamednader.shoponthego.Model.Pojo.Customers.Customer("John", "Doe", true, "password"))
        ...
        // then
        val result = viewModel.customer.first()
        assertEquals(ApiState.Failure(IllegalArgumentException("Invalid input")), result)
    }
}
