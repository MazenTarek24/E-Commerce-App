...
data class Customermo (
  ...
  @SerializedName("email_marketing_consent"      ) var emailMarketingConsent     : EmailMarketingConsentmo? = EmailMarketingConsentmo(),
  @SerializedName("sms_marketing_consent"        ) var smsMarketingConsent       : SmsMarketingConsentmo?   = SmsMarketingConsentmo(),
  @SerializedName("admin_graphql_api_id"         ) var adminGraphqlApiId         : String?                = null,
  @SerializedName("default_address"              ) var defaultAddress            : DefaultAddressmo?        = DefaultAddressmo()
