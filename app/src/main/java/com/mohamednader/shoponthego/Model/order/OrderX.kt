...
data class OrderX(
    ...
    val line_items: List<LineItemX>?= null,
    ...
    val payment_gateway_names: ArrayList<String>?= null,
    ...
    val tax_lines: List<TaxLineXXX>?= null,
    ...
    val total_tax_set: TotalTaxSetX?= null,
