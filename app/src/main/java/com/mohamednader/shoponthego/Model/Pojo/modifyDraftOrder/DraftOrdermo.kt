...
data class DraftOrdermo (
    ...
    @SerializedName("line_items"                 ) var lineItems              : ArrayList<LineItemmo>    = arrayListOf(),
    ...
    @SerializedName("applied_discount"           ) var appliedDiscount        : AppliedDiscountmo?        = AppliedDiscountmo(),
    @SerializedName("order_id"                   ) var orderId                : String?                 = null,
    @SerializedName("shipping_line"              ) var shippingLine           : ShippingLinemo?           = ShippingLinemo(),
    ...
    @SerializedName("customer"                   ) var customer               : Customermo?               = Customermo()
